...
(function () {
	...
	window.SBTSScheduleAction = function (actionName, actionTimeString) {
		...
		this.render = function () {
			...
			var actionRepeatString = '';
			
			if (this.repeats == SBTSScheduleRepeat.Weekly) {
				actionRepeatString = '<b>Weekly</b>';
			}else{
				actionRepeatString = 'No';
			}
			
			return '<div class="action'+ isNewClass +'">\
				<div class="repeats">' + actionRepeatString + '</div>' + this.name + '</div>';
		}
	}
